...
const ConfermridePopupPanel = (props) => {
 ...
 <div>
         ...
         <h5
           ...
           className='p-1 w-[93%] text-center absolute top-0 '><i className="text-3xl text-gray-500 ri-arrow-drop-down-line"></i></h5>
            ...
            <h3 className='text-2xl font-semibold mb-5'>Conferm this ride to Start !</h3>
            ...
            <p className='text-sm -mt-1 text-gray-600'>Cash Cash</p>
                ...
                <div className='flex w-full items-center justify-between'>
                   <form onSubmit={(e)=>{
                    ...
                    <input value={otp} onChange={(e)=>setotp(e.target.value)}  className='bg-[#eeeeee] mb-5 rounded-2xl px-6 py-4 font-mono border w-full text-lg placeholder:text-base'
                ...
                onClick={()=>{
                 ...
                 className='w-full mt-1 text-lg bg-red-500 text-white font-semibold p-3 px-8 rounded-lg'>Cancel</button>
                    <Link
                to="/Captain-riding"
                 className='flex justify-center text-lg  mt-5 bg-green-600 text-white font-semibold p-3 px-8 rounded-lg'>Conferm</Link>
                   </form>
...
export default ConfermridePopupPanel