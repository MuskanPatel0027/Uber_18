...
const CaptainSignup = () => {
  ...
  return (
    <div className='p-7 flex flex-col justify-between h-screen'>
      ...
      <div>
       <p className='text-[10px] mt-6 leading-tight'>This site is protected by reCAPTCHA and the Google <span className='underline'>Privacy Policy </span>and <span className='underline'>Terms of Services</span> apply.</p>
      </div>
