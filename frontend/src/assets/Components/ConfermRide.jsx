    ...
    <div>
         ...
         <h5
           ...
           className='p-1 w-[93%] text-center absolute top-0 '><i className="text-3xl text-gray-500 ri-arrow-drop-down-line"></i></h5>
            ...
            <h3 className='text-2xl font-semibold mb-5'>Conferm your Ride</h3>
        ...
        <div>
            ...
            <p className='text-sm -mt-1 text-gray-600'>Cash Cash</p>
                ...
                onClick={()=>{
                    ...
                    props.setconfermRidePanel(false);
                }}
                 className='w-full mt-5 bg-green-600 text-white font-semibold p-2 rounded-lg'>Conferm</button>
            </div>
    </div>
  )
}

export default ConfermRide